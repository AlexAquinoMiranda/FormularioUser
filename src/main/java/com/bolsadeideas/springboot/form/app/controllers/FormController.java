...
public class FormController {
	...
	public List<String> genero() {
		return Arrays.asList("Hombre", "Mujer", "prefiero no comentar");
	}
	...
	public List<String> paises() {
		return Arrays.asList("España", "México", "Chile", "Argentina", "Perú", "Colombia", "Venezuela", "Brasil", "Australia");
	...
	public String form(Model model) {
		...
		usuario.setPais(new Pais(3, "ES", "España"));
	...
	public String ver(@SessionAttribute(name = "usuario", required = false) Usuario usuario, Model model,
		...
		model.addAttribute("titulo", "Datos registrados");
